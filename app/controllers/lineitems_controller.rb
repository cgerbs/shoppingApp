class LineitemsController < ApplicationController
  ...
  def create
    ...
    #@lineitem = @list.lineitems.build(player_id: player)
    @lineitem = @list.add_item(player.id)
    respond_to do |format|
      if @lineitem.save
        format.html { redirect_to recruiter_url, notice: "Lineitem was successfully created." }
        #format.js
  ...
  def lineitem_params
    params.require(:lineitem).permit(:player_id, :list_id)
  end
end
