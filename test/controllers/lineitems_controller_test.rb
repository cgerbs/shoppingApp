...
class LineitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post lineitems_url, params: { lineitem: { list_id: @lineitem.list_id, player_id: @lineitem.player_id } }
    end
  ...
  test "should update lineitem" do
    patch lineitem_url(@lineitem), params: { lineitem: { list_id: @lineitem.list_id, player_id: @lineitem.player_id } }
